...
function backToTop(pageW){
	...
	pageW=pageW||0;
	var w=jisuanW(pageW);
	var $backToTopEle = $('<div class="go_top" id="backToTop"></div>').appendTo($("body")).click(function() {$("html, body").animate({ scrollTop: 0 }, 120);});
