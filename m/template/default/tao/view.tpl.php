...
<?php if($shuju_data['title']!=''){?>
    ...
    <dd>
      ...
      <p class="p2"><span class="span1"><?=FANLI_WORD1?></span><span class="span2" style="color:#060"><?=FANLI_WORD?></span></p>
 ...
 <?php }else{?>
    <a href="m/index.php?mod=jump&act=index&a=tb&iid=<?=$shuju_data['num_iid']?>" target="_blank"class="left click_url">去淘宝购买</a>
 <?php }?>
 
  <a href="javascript:;" onClick="history.back()" class="right">返回列表</a></p>
   <a href="javascript:;" class="data" style="cursor:text;"><span><font>提醒：</font><strong style="font-weight:normal; color:#EE2E5B; font-size:0.8em">如果跳淘宝手机APP可以正常<?=FANLI_WORD1?>！</strong></span></a>
  <p class="line"></p>
