...
function index_tpl(){/*<li><a href="{$url}"> <span class="mu-tmb lazyload"><img data-original="{$img}" title="{$title}" class="lazy" src="<?=$dd_tpl_data['loading_img']?>" style="width:100px; height:100px; margin:0 auto;display: block;"> </span> <span style=" font-size:1em; max-height:3em; overflow:hidden; overflow:hidden; display:block">{$title}</span>
...
<div class="mc radius">
	<ul class="mu-l2w shuju_load">
		...
		<li> <a href="<?=$row['url']?>"> <span class="mu-tmb"><img data-original="<?=$row['img']?>" title="<?=$row['title']?>" src="<?=$dd_tpl_data['loading_img']?>" class="lazy" style="width:100px; height:100px; margin:0 auto;display: block;"> </span> <span style=" font-size:1em; max-height:3em;overflow:hidden; overflow:hidden; display:block"><?=$row['title']?></span>
