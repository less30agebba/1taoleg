...
?>
      ...
      <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
                    <tr> 
                      <th width="20%">排名</th>
					  <th width="25%">会员名</th>
                      <th width="30%">总推广佣金（元）</th>
                       <th width="">总推广会员数（位）</th>
                    </tr>
					<?php foreach ($row_2 as $k=>$r){?>
					  <tr>
                      	<td>第<?=($page-1)*$pagesize+($k+1)?>名</td>
                        <td><a href="<?=u('user','list',array('se1'=>'tjr','q'=>$r['ddusername']))?>"><?=$r["ddusername"]?></a></td>
                        <td><span style="color:#F00;font-weight:bold"><?=(float)$r['sum']?></span></td>
                        <td><span style="color:#F00;font-weight:bold"><?=$r['user_sum']?></span></td>
					  </tr>
					<?php }?>
      </table>
