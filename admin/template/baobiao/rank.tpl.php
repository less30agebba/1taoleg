...
<form name="form2" method="get" action="index.php?mod=<?=MOD?>&act=<?=ACT?>" style="margin:0px; padding:0px">
      ...
      <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
                    <tr> 
                    	<th width="10%">排名</th>
					  <th width="25%">会员名</th>
                      <th width="15%">总获得<?=TBMONEY?>(个)</th>
                      <th width="15%">现有<?=TBMONEY?>(个)</th>
                      <th width="15%">已提现<?=TBMONEY?>(个)</th>
                      <th width="">注册时间</th>
                    </tr>
					<?php foreach ($row as $k=>$r){?>
					  <tr>
                        ...
                        <td><span style="color:#F00;font-weight:bold"><?=$r['jifenbao']+$r['tbyitixian']?></span></td>
                         <td><span style="color:#F00;font-weight:bold"><?=(int)$r['jifenbao']?></span></td>
                          <td><span style="color:#F00;font-weight:bold"><?=(int)$r['tbyitixian']?></span></td>
						<td><?=$r["regtime"]?></td>
					  </tr>
					<?php }?>
      </table>
