...
<form name="form2" method="get" action="index.php?mod=<?=MOD?>&act=<?=ACT?>" style="margin:0px; padding:0px">
      ...
      <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
                    <tr> 
                      <th width="10%">排名</th>
					  <th width="25%">会员名</th>
                       <th width="15%">总获得金额(元)</th>
                      <th width="15%">现有金额(元)</th>
					...
					<?php foreach ($row as $k=>$r){?>
					  <tr>
                        ...
                        <td><span style="color:#F00;font-weight:bold"><?=$r['money']+$r['yitixian']?></span></td>
                         <td><span style="color:#F00;font-weight:bold"><?=(int)$r['money']?></span></td>
                          <td><span style="color:#F00;font-weight:bold"><?=(int)$r['yitixian']?></span></td>
						<td><?=$r["regtime"]?></td>
					  </tr>
					<?php }?>
      </table>
