...
$pagesize=(int)get_cookie('admin_xls_pagesize');
if($pagesize==0){
	$pagesize=100;
}
...
<div class="explain-col"> 提示：导入的淘宝订单没有购买会员的信息，站长仔细看清后操作！<a href="http://pub.alimama.com/myunion.htm#!/report/detail/taoke" target="_blank">点击获取最新的淘宝客推广明细</a> </div>
<form method="post" action="index.php?mod=<?=MOD?>&act=<?=ACT?>" enctype="multipart/form-data" name="form1">
  <table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
    ...
    <tr>
      ...
      <td>&nbsp;
        <input name="pagesize" type="text" value="<?=$pagesize?>" style="width:60px"/> <span class="zhushi">导入数据后，每次处理订单的数量，站长可根据自己的服务器性能调节</span></td>
    </tr>
    <tr>
      <td align="right">&nbsp;</td>
      <td>&nbsp;
