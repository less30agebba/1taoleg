  ...
  <tr class="offer_set">
    <td align="right">选择视图格式：</td>
     <td><table width="600" border="0">
                  <tr>
                    <?=offer_radio(array(1=>'Basic风格','Win10风格'),$webset['offer']['type']?$webset['offer']['type']:1,'offer[type]')?>
                  </tr>
                  <tr>
                    <td>&nbsp;<img src="<?=DD_YUN_URL?>/Public/images/offer/offer_Basic.jpg" width="150"/></td>
                    <td>&nbsp;<img src="<?=DD_YUN_URL?>/Public/images/offer/offer_Win10.jpg" width="150"/></td>
                  </tr>
                </table>
    </td>
  </tr>
