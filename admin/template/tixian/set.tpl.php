...
?>
<style>
.tixianddpay_guanlian{ display:none}
</style>
<script>
$(function(){
	<?=radio_guanlian('tixian[ddpay]')?>	   
...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;每月<input style=" width:60px;"  name="tixian[day]" value="<?=$webset['tixian']['day']?>" />号以后&nbsp;&nbsp;<span class="zhushi">填20表示 每月20号以后才能申请提现 0表示不限制</span></td>
  </tr>
  <tr>
  ...
  <tr class="tixianddpay_guanlian">
    <td align="right">免审发放额度：</td>
    <td>&nbsp;<input style=" width:60px;"  name="tixian[mianshen]" value="<?=$webset['tixian']['mianshen']?>" /><span class="zhushi">0表示全部需要审核，100表示100及100以内集分宝无需审核直接发放</span></td>
  </tr>
  <tr class="tixianddpay_guanlian">
