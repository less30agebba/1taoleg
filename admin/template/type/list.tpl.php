...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        <tr>
              <td width="250px">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<a href="<?=u(MOD,'addedi')?>" class="link3">[新增分类]</a>&nbsp;<?php if($mod_tag=='goods'){?><a href="<?=u(MOD,'addedi',array('do'=>'chongzhi'))?>" class="link3">[重置分类]</a><?php }?></td>
              <td width="" align="right">分类名：<input type="text" name="q" value="<?=$q?>" />&nbsp;<input type="submit" value="搜索" /></td>
