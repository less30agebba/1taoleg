...
if($_POST['sub']!=''){
	...
	$_POST['quan_stime']=!empty($_POST['quan_stime'])?strtotime($_POST['quan_stime']):0;
	$_POST['quan_etime']=!empty($_POST['quan_etime'])?strtotime($_POST['quan_etime']):0;
	$_POST['quan_total']=(int)$_POST['quan_total'];
	$_POST['quan_price']=(float)$_POST['quan_price'];
	$_POST['quan_surplus']=(int)$_POST['quan_surplus'];
	if(empty($id)){
		$_POST['addtime']=time();
