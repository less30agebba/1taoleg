...
if ($mod != 'login') {
	if(empty($_SESSION['ddadmin'])){
		$_SESSION['ddadmin']=dd_json_decode(get_cookie('ddadmin'),1);
	}
	...
	if ($ddadmin['name'] == '') {
		...
		$admin=$duoduo->select('duoduo2010','*','adminname="'.$ddadmin['name'].'" and adminpass="'.$ddadmin['pass'].'"');
