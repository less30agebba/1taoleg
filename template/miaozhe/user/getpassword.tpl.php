...
<div id="maincenter">
  ...
  <tr>
    ...
    <td width="258" align="left"><div  style="margin-top:-15px"><input name="sub" type="submit" value="找回密码"/ class="bbtt" ></div></td>
  </tr>
  <tr>
    ...
    <table width="500" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td height="35" align="left"><input type="hidden" name="x" value="<?=$x?>" />
          <input type="submit" name="Submit" value="重置密码" class="bbtt" />
