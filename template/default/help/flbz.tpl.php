...
<div style="background:url(<?=TPLURL?>/inc/images/help/diban.jpg) repeat-x; width:100%">
	<div class="top_bbg">
    	<div class="wenzi">
            <p class="first">淘宝<?=FANLI_WORD1?><span>新</span>玩法</p>
            <p class="two">粘贴商品标题到网站，查询后将跳转到爱淘宝，找到你想买的商品并购买，确认收货后记得回网站拿<?=FANLI_WORD1?>哦。</p>
        </div>
    </div>
    </div>
<div class="mid_bbg">
    ...
    <div class="zjnr_bgg" style="padding-bottom:20px;">
    	<div class="con">
        	<h3><span style="margin-right:15px; font-size:36px;">第3步</span>确认收货后回网站拿<?=FANLI_WORD1?></h3>
    ...
    <div style="background:none; width:1000px; float:left; margin-bottom:20px;">
        ...
        <div class="wendas">
            <dl>
                ...
                <dd>
                    <em>A：</em> 可以的，根据新规则，不能在本网站查<?=FANLI_WORD1?>了，但只要搜索去淘宝下单购买 都有<?=FANLI_WORD1?>的。
                </dd>
            </dl>
            <dl>
                <dt>
                ...
                <dd>
                    <em>A：</em> 搜索商品跳转到淘宝后根据您找的淘宝商品旺旺名称确定是否为您找的商品。如果找不到 说明此商品无<?=FANLI_WORD1?>。
                </dd>
            </dl>
            <dl>
                <dt>
                    <em>Q：</em> 有什么简易方法能快速拿<?=FANLI_WORD1?>吗？
                </dt>
                <dd>
                    <em>A：</em> 建议收藏我们网站，每次去淘宝购物前先到我们网站搜索去淘宝找商品，只要通过本站去淘宝搜索购物都有<?=FANLI_WORD1?>，这样不用找到商品复制商品名称到我们网站来搜索拿<?=FANLI_WORD1?>了。
                </dd>
            </dl>
            <dl>
                <dt>
                    <em>Q：</em> 商家宝贝打折优惠时，可以<?=FANLI_WORD1?>吗？<?=FANLI_WORD1?>是怎么算的
                </dt>
                <dd>
                    <em>A：</em> 商家宝贝有打折优惠时，可以在成交价的基础上获得<?=FANLI_WORD1?>，享受折上折待遇。
                </dd>
            </dl>
            <dl>
                <dt>
                    <em>Q：</em> 聚划算有<?=FANLI_WORD1?>吗？
                </dt>
                <dd>
                    <em>A：</em> 聚划算没有<?=FANLI_WORD1?>了。
                </dd>
            </dl>
            <dl class="last">
                <dt>
                    <em>Q：</em> 货到付款是否可以得到<?=FANLI_WORD1?>？
                </dt>
                <dd>
                    <em>A：</em> 货到付款暂时无法得到<?=FANLI_WORD1?>，建议使用网上支付。
                </dd>
            </dl>
