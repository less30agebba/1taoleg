...
<div class="w1000" style="margin:auto">
...
$(function(){
	...
	ajaxLoad('.infinite_scroll','.megas512',<?=$ajax_load_num?>,'<?=u(MOD,'baobei',array('xs'=>$xs,'uid'=>$uid,'cid'=>$cid))?>',<?=$contentData?>,500,LazyLoad);
	<?php }?>
})
</script>
<?php
