    	...
    	<div class="adminmain">
            ...
            <div class="c_border" style="border-top-style:solid; border-top-width:2px;padding-top:10px;">
                ...
                <div class="adminright_yuye">
                    ...
                    <p>成功邀请好友后，只要教您的好友从本站去淘宝、拍拍等商城购物拿<?=FANLI_WORD1?>，您最高可以获取<span style="color:#FF0000"><?=$webset['tgfz']?> </span>元 作为邀请好友的<?=FANLI_WORD1?>！<a id="shoutusm" href="" style="text-decoration:underline">详细说明</a></p>
                </div>
                <?php if($do=='list'){?> 
                <div class="admin_table">
                    <table width="770" border="0" cellpadding="0" cellspacing="1">
                      <tr>
                        ...
                        <th width="184">已获<?=FANLI_WORD1?></th>
...
<INPUT class=text value="<?=$webset['tgurl']?>rec=<?=$rec?> 亲爱的，有个省钱利器我必须告诉你，能省很多Money！" type=text id="copy_txt0"> <INPUT class=smt  value="复制邀请连接" type="button" id="copy_btn0" data='0'/> 
</DIV></DIV>
...
$(function(){
    $('#shoutusm').jumpBox({  
		...
		titlebg:1,
		LightBox:'show',
	    contain: '<p style=" line-height:25px; font-size:14px">邀请成功后，将按照您好友<?=FANLI_WORD1?>额的<?=$webset['tgbl']*100?>%来获取<?=FANLI_WORD1?>，直到最高<?=FANLI_WORD1?>额度<?=$webset['tgfz']?>元时，该好友将成为您的完成好友。</p>',
		height:180,
		width:400
    });
});
