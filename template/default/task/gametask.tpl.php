...
<div class="mainbody" style="height:2000px; width:1020px; position:relative;">
    ...
    <a id="tiplogin-beijing" style="display:none; " href="<?=u('user','login',array('from'=>CUR_URL))?>" ><div style="width: 1020px; height: 100%;position:absolute; top:0px; left:50%; margin-left:-510px; background-color:#fff;filter:alpha(opacity=10);-moz-opacity:0.1;-khtml-opacity: 0.1;opacity: 0.1;">&nbsp;</div></a>
</div>
<!--新的U站插件版本20140225-->
