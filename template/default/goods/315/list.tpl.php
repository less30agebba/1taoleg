...
<div class="list-good">
<div class="left">
<a href="<?=$row['url']?>" target="_blank"><?=dd_html_img($row['img'],$row['title'],310)?>
...
<div class="tp_ab">
    ...
    <div class="tp_bq tp_2 erweima dd_cure click_url" dd-href="?mod=goods&act=view&iid=<?=$row['data_id']?>&id=<?=$row['id']?>&click_url=" data-itemid="<?=$row['data_id']?>" isconvert=1 id="<?=$row['id']?>&uid=<?=$dduser['id']?>" url="<?=$row['url']?>" youhui="<?=$row['shouji_price_cha']?>">
...
<div class="opca"></div>
<?php }?><?php */?>
<a href="<?=$row['url']?>" class="click_url" dd-href="?mod=goods&act=view&iid=<?=$row['data_id']?>&id=<?=$row['id']?>&click_url=" data-itemid="<?=$row['data_id']?>" isconvert=1 target="_blank"><div class="jy_title"><?=$row['title']?></div></a>
<div class="jy_nr">
<div class="jy_price">
	<div class="inblock">
...
<?php if(FANLI==1){?><span class="biaoqian qingse"><?=FANLI_WORD?></span><?php }?>
    </div>
    <?php if($row['sell']){?>
    <div class="inblock" style="float:right;">
    	<div class="jy_w_buy">
