...
<?php foreach($goods_list as $row){?>
    <li>
      <div class="list-good">
        <div class="left"> <a href="<?=$row['url']?>" target="_blank"><?=dd_html_img($row['img'],$row['title'],250)?>
        ...
        <?php }?>
          ...
          <div class="tp_ab">
            ...
            <div class="tp_bq tp_2 erweima dd_cure click_url" id="<?=$row['id']?>&uid=<?=$dduser['id']?>" dd-href="?mod=goods&act=view&iid=<?=$row['data_id']?>&id=<?=$row['id']?>&click_url=" data-itemid="<?=$row['data_id']?>" isconvert=1 url="<?=$row['url']?>" youhui="<?=$row['shouji_price_cha']?>">
        ...
        <div class="opca"></div>
		<?php }?><?php */?>
        <a href="<?=$row['url']?>" class="click_url" dd-href="?mod=goods&act=view&iid=<?=$row['data_id']?>&id=<?=$row['id']?>&click_url=" data-itemid="<?=$row['data_id']?>" isconvert=1 target="_blank">
