    	...
    	<div class="adminmain">
        	...
        	<div class="adminright">
                ...
                <div class="userdaohang">
                  <ul>
                    <li id="myinfo" style="width:172px"><a href="<?=u('user','info',array('do'=>'myinfo'))?>">修改资料</a> </li>
                    <li id="pwd" style="width:172px"><a href="<?=u('user','info',array('do'=>'pwd'))?>">修改密码</a> </li>
                    <li id="caiwu" style="width:172px"><a href="<?=u('user','info',array('do'=>'caiwu'))?>">收款支付宝</a> </li>
                    <?php if($webset['sms']['open']==1){?>
                    <li id="mobile" style="width:172px"><a href="<?=u('user','info',array('do'=>'mobile'))?>">手机验证</a> </li>
                    <?php }?>
                    <?php if($app_show==1){?>
                    <li id="apilogin" style="width:172px"><a href="<?=u('user','info',array('do'=>'apilogin'))?>">账号通设置</a> </li>
                    <?php }?>

                  <?php if(FANLI==1){?>  <li id="tbnick" style="width:172px"><a href="<?=u('user','info',array('do'=>'tbnick'))?>">订单跟踪账号</a> </li>  <?php }?>
    ...
    <table border="0" align="left" cellpadding="0" cellspacing="0" class="no_table">
       ...
       <?php if($webset['ucenter']['open']==1){?>
        <tr>
		  ...
		  <td width="150"><input name="old_password" type="password" id="old_password" value="" class="ddinput"/></td>
        ...
        <tr>
		  ...
		  <td width="150"><input name="email" type="text" id="email" value="<?=$dduser['email']?>" class="ddinput"/></td>
		...
		<tr>
		  ...
		  <td width="25%"><input name="old_password" type="password" id="old_password" class="ddinput" /></td>
		...
		<tr>
		  ...
		  <td><input name="qq" type="text" id="qq" value="<?=$dduser['qq']?>"  onkeyup="value=value.replace(/[^\d]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" size="20" maxlength="50" class="ddinput"/></td>
		  <td id="ckqq2"><label class="field_notice">以便客服及时联系您</label></td>
		</tr>
		<tr>
		  <td height="35" style="text-align:right">电子邮箱 *&nbsp;&nbsp;&nbsp;</td>
		  <td><input name="email" type="text" id="email" value="<?=$dduser['email']?>" class="ddinput"/></td>
        ...
        <tr>
		  <td height="35" style="text-align:right">手机号码 *&nbsp;&nbsp;&nbsp;</td>
		  <td><input name="mobile" type="text" id="mobile" value="<?=$dduser['mobile']?>" class="ddinput"/></td>
		...
		<tr>
		  <td height="35">&nbsp;</td>
		  <td><input type="hidden" name="sub" value="1" /><input type="submit" value="保存信息" class="bbtt2" /></td>
		  <td></td>
		</tr>
	  </table>
      </form>
...
<?php }?>
    ...
    <table border="0" align="left" cellpadding="0" cellspacing="0" bordercolorlight="#9acd32" class="no_table">
		<tr>
		  ...
		  <td width="25%"><input name="old_pwd" type="password" id="old_pwd" class="ddinput" /></td>
		...
		<tr>
		  ...
		  <td><input name="ddpwd" type="password" id="ddpwd" size="20" maxlength="20" class="ddinput"/></td>
		  <td id="ckpass"><label class="field_notice">密码为长度 6 - 20 位</label></td>
		</tr>
		<tr>
		  <td height="35" style="text-align:right">确认新网站登录密码 *&nbsp;&nbsp;&nbsp;</td>
		  <td><input name="pwd_confirm" type="password" id="pwd_confirm" class="ddinput"/></td>
    ...
    <table border="0" align="left" cellpadding="0" cellspacing="0" bordercolorlight="#9acd32" class="no_table">
        ...
        <tr>
		  ...
		  <td><input name="realname" type="text" id="realname" value="<?=$dduser['realname']?>" maxlength="50" <?php if ($dduser['realname']!=""){ echo "readonly='readonly' disabled";}?> class="ddinput"/></td>
		...
		<tr>
		  ...
		  <td><input name="alipay" type="text" id="alipay" value="<?=$dduser['alipay']?>" maxlength="50" <?php if ($dduser['alipay']!=""){ echo "readonly='readonly' disabled";}?> class="ddinput"/></td>
		  <td><label class="field_notice">填写后不可更改</label><label id="checking_my_alipay" class="checking">检查中...</label></td>
		</tr>
		<tr height="40">
		  <td height="35" style="text-align:right"></td>
		  <td colspan="2"><label class="field_notice">为了保证资金安全，填写后不可更改，<font color="#FF0000">如需修改联系客服</font>&nbsp;&nbsp;<a href="tencent://message/?uin=<?=$dd_tpl_data['qq']?>"  rel="nofollow"><img src="<?=TPLURL?>/inc/images/user/qq.png" width="74" height="22" alt=""></a></label>		    <label id="checking_my_alipay" class="checking">检查中...</label></td>
		  </tr>
        <?php }?>
        <?php if($webset['tixian']['need_tenpay']==1){?>
        <tr>
		  <td height="35" style="text-align:right">财付通账号 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		  <td><input name="tenpay" type="text" id="tenpay" value="<?=$dduser['tenpay']?>" maxlength="50" <?php if ($dduser['tenpay']!=""){ echo "readonly='readonly' disabled";}?> class="ddinput"/></td>
        ...
        <tr>
		  ...
		  <td><input name="bank_code" type="text" id="bank_code" value="<?=$dduser['bank_code']?>" class="ddinput"/></td>
...
<?php }elseif($do=='tbnick'){?>
    ...
    <?php foreach($tbnick_arr as $k=>$v){?>
        <tr <?php if($v){?>id="tbnick_tr_<?=$k?>"<?php }?>>
		  <td height="35" style="text-align:right">淘宝账号/订单号 *&nbsp;&nbsp;&nbsp;</td>
		  <td><input name="tbnick[<?=$k?>]" type="text" id="tbnick_<?=$k?>" value="<?=$v?>" class="ddinput"/></td>
<?php if($v){?><td><span onClick="delete_tr('tbnick_tr_<?=$k?>')" title="点击删除该账号" style="color:#666; cursor:pointer; margin-left:5px;">删除</span></td><?php }?>
		  <td><?php if($k==0){?><label class="field_notice">只是登记拿返利，不需要密码，请放心。<?php if($dd_tpl_data['jiaocheng']['tbnick']!=''){?><a href="<?=$dd_tpl_data['jiaocheng']['tbnick']?>" target="_blank" style="color:#F00">如何填？</a><?php }?></label><?php }?><label id="checking_tbnick_<?=$k?>" class="checking">检查中...</label></td>
		</tr>
    <?php }?>
		<tr>
		  <td height="35">&nbsp;</td>
