    	...
    	<div class="adminmain">
        	...
        	<div class="adminright">
                ...
                <div class="adminright_yuye">
                    ...
                    <p>成功收到徒弟后，只要教您的徒弟从本站去淘宝、拍拍等商城购物拿<?=FANLI_WORD1?>，您最高可以获取<span style="color:#FF0000"><?=$webset['tgfz']?> </span>元 作为带您徒弟的<?=FANLI_WORD1?>！<a id="shoutusm" href="" style="text-decoration:underline">详细说明</a></p>
                </div>
                <?php if($do=='list'){?> 
...
$(function(){
    $('#shoutusm').jumpBox({  
		...
		titlebg:1,
		LightBox:'show',
	    contain: '<p style=" line-height:25px; font-size:14px">收徒成功后，将按照您徒弟<?=FANLI_WORD1?>额的<?=$webset['tgbl']*100?>%来获取<?=FANLI_WORD1?>，直到最高<?=FANLI_WORD1?>额度<?=$webset['tgfz']?>元时结束师徒的关系</p>',
		height:180,
		width:400
    });
});
