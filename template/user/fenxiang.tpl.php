    	...
    	<div class="adminmain">
        	...
        	<div class="adminright" style="padding-top:10px">
                   ...
                   <table width="770" border="0" cellspacing="0" cellpadding="0" class="admin_table_fx">
                      <tr>
                        ...
                        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td height="34">下单时间：<?=date('Y-m-d',strtotime($row["date"]))?> &nbsp;&nbsp;&nbsp; 状态：<?=$row["status"]==0?'未确认':'已确认'?> &nbsp;&nbsp;&nbsp; <?=FANLI_WORD1?>：<?=$row["money"]?$row["money"]:'——'?> &nbsp;&nbsp;&nbsp; 确认时间：<?=$row["status"]?$row["pay_time"]:'——'?></td>
                          </tr>
                        </table></td>
                      </tr>
                </table>
                ...
                <div class="admin_botton" style=" padding-left:0px; height:80px; width:170px">
                    ...
                    <?php if($webset['baobei']['shai_jifen']>0 || $webset['baobei']['shai_jifenbao']>0){?><span style="float:left; padding:5px 0;"><i style="font-style:normal;">晒单<?=FANLI_WORD1?>:</i><?php if($webset['baobei']['shai_jifen']>0){?><span style="color:#060;"><?=$webset['baobei']['shai_jifen']?>积分</span><?php }?>&nbsp;<?php if($webset['baobei']['shai_jifenbao']>0){?><span style="color:#f00;"><?=$webset['baobei']['shai_jifenbao'].TBMONEY?></span><?php }?></span><?php }?>
                </div>
                </div>
            </div>
    	</div>
