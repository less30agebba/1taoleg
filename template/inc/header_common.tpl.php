	...
	<div class="vipduo_top_menu">
		<div class="vipduo_top_link">
		   ...
		   <div class="menu_title">
            ...
            <div class="menu_content">
            	<ul>
                	<li><a onclick="AddFavorite('','一淘乐购')"><div class="menu_list_title"><div class="vipduo_ico ico_collection"></div>加入收藏</div></a></li>			
...
<div id="shownav">
	...
	<div class="flbg"></div>	
			<ul class="tb-cat">
					...
					<i class="catico-1"></i>
					<a target="_blank"  href="index.php?mod=goods&act=index&cid=10001" class="biaotis">女装/Women's wear</a> 
							</li>
								<li data-submenu-id="tb-subcat2">
					<i class="catico-2"></i>
					<a target="_blank"  href="/index.php?mod=goods&act=index&cid=10002" class="biaotis">鞋包/Shoe bag</a>
					
								</li>
								<li data-submenu-id="tb-subcat3">
					<i class="catico-3"></i>
					<a target="_blank"  href="/index.php?mod=goods&act=index&cid=10003" class="biaotis">美妆/Beauty makeup</a>
					
									</li>
								<li data-submenu-id="tb-subcat4">
					<i class="catico-4"></i>
					<a target="_blank"  href="/index.php?mod=goods&act=index&cid=10004" class="biaotis">美食/Delicious food</a>
...
Children's</a> 
					...
					<i class="catico-8"></i>
					<a target="_blank"  href="/index.php?mod=goods&act=index&cid=10008" class="biaotis">手机/Mobile phone</a>
									</li>
