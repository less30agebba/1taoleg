...
$css[]="css/kefu.css";
if($dd_tpl_data['fanli-kg']['open']==0){
$css[]=TPLURL."/inc/css/vipduo.css";
}else{
$css[]=TPLURL."/inc/css/head_taoke.css";
}
...
.gm .tejia{background:<?=$dd_tpl_data['tebie']?>;color:#fff;}
...
<?php }?>
  ...
  <?php if($mod=='index'){?>
   <?php if($dd_tpl_data['ads-kg']==1){?>
<?php include(TPLPATH.'/vip/ad.tpl.php');?>
 <?php }?> <?php }?>

<?php include(TPLPATH.'/inc/header_common1.tpl.php');?>