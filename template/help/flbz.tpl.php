<?php
$css[]=TPLURL."/css/flbz.css";
include(TPLPATH.'/inc/header3.tpl.php');
?>

<div style="background:url(<?=TPLURL?>/images/help/diban.jpg) repeat-x; width:100%">
	<div class="top_bbg">
    	<div class="wenzi">
...
<div class="mid_bbg">
    ...
    <div class="zjnr_bgg">
    	<div class="con">
            ...
            <img src="<?=TPLURL?>/images/help/step_1.jpg" />
            <img src="<?=TPLURL?>/images/help/step_2.jpg" />
        </div>
    </div>
    <div style="clear:both"></div>
    <div class="zjnr_bgg">
    	<div class="con">
            ...
            <img src="<?=TPLURL?>/images/help/step_3.jpg" />
            <img src="<?=TPLURL?>/images/help/step_4.jpg" />
        </div>
    </div>
    <div style="clear:both"></div>
    <div class="zjnr_bgg" style="padding-bottom:20px;">
    	<div class="con">
            ...
            <img src="<?=TPLURL?>/images/help/step_5.jpg" />
        </div>
    </div>
    <div style="clear:both"></div>
    <div style="background:none; width:1000px; float:left;">
    	<div class="con">
            <a class="shishi" href="<?=u('index','index')?>" target="_blank"></a>
            <a class="right" href="<?=u('help','index')?>" target="_blank"></a>
        </div>
    </div>
    <div style="clear:both"></div>
    <div style="background:none; width:1000px; float:left; margin-bottom:20px;">
        ...
        <div class="wendas">
            ...
            <a class="btn-tbg-more" target="_blank" href="<?=u('help','index')?>">
				<img width="183" height="48" alt="查看更多解答" src="<?=TPLURL?>/images/help/jieda_btn.jpg">
			</a>
        </div>
    </div>
    <div style="clear:both"></div>
