      ...
      <div class="demo clearfix">
        <div class="item_list infinite_scroll">
          ...
          <div class="item masonry_brick">
            <div class="item_t">
              <div class="img tb_img"> <a href="<?=$v['url']?>" target="_blank"><?=dd_html_img($v['userimg'],$v['title'],'200')?></a> <span class="price">￥<?=$v['price']?><?php if($v['fxje']>0  && FANLI==1){?><span style="margin-left:15px;" title="返<?=$v['fxje'].TBMONEY?>">返<?=$v['fxje']?></span><?php }?></span>
              </div>
  ...
  <div class="shai_n_r">
    <div class="pad15">
      ...
      <div class="view_name"> <span><a target="_blank" href="<?=$baobei['jump']?>"><?=$baobei['title']?></a></span> </div>
          <div class="n_price"> <span style="margin-right:15px;">¥<?=(float)$baobei['price']?></span><?php if(FANLI==1){?><span style="font-size:12px;" title="<?php if($baobei['fxje']==0){?>返<?=$baobei['fxje'].TBMONEY?><?php }?>"><?php if($baobei['fxje']==0){?>有返利<?php }else{?>返<?=$baobei['fxje']?><?=TBMONEY?><?php }?></span><?php }?></div>
    ...
    <div class="qitasp"> TA的其他的照片
      ...
      <div class="sp_img"> <a href="<?=$v['url']?>"  target="_blank"> <?=dd_html_img($v['userimg'],$v['title'],240)?> </a>
        ...
        <div class="s_price"> <span>¥<?=$v['price']?></span><!--<del>50.00</del>--><?php if(FANLI==1){?><span style="float:right;" title="<?php if($v['fxje']==0){?>返<?=$v['fxje'].TBMONEY?><?php }?>"><?php if($v['fxje']==0){?>有返利<?php }else{?>返<?=$v['fxje']?><?php }?></span><?php }?> </div>
      </div>
      <?php }?>
    </div>
  </div>
