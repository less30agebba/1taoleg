...
<div class="biaozhun5" style="width:1000px; background:#FFF;  margin:auto; margin-top:10px; padding-bottom:10px">
	<div id="jmain" style="width:950px; margin:auto;">
        ...
        <?php }?>
		<div class="qa">
			<li><h2>什么是集分宝？<?=FANLI_WORD1?>兑换集分宝有什么好处？</h2></li>
		...
		<div class="qa">
			<li><h2><?=FANLI_WORD1?>如何兑换到集分宝？</h2></li>
			<p><?=WEBNAME?>已与支付宝集分宝进行深入合作，您在<?=WEBNAME?>获得的<?=FANLI_WORD1?>收入（包含<?=TBMONEY?>）可随时申请兑换。<?=FANLI_WORD1?>兑换集分宝过程中的所有手续费成本，由<?=WEBNAME?>承担，您无需支付任何额外费用。
		...
		<p style="font-weight:bolder;padding:20px;">怎么样，集分宝很好用吧？<br />还不赶紧试试<a class="link" target="_blank" href="<?=u('huan','list')?>"><?=FANLI_WORD1?>兑换集分宝</a>，让你网购省钱更便捷！</p>		
		</div>
	</div>
