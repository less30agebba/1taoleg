...
include(TPLPATH.'/inc/header1.tpl.php');
?>
...
<div class="mainbody1000" style="margin:15px 0">
<div class="register" style="padding:30px 0 50px 0">
    <div class="register_left">
     <p class="title">登录一淘乐购立即拿返利</p>
     ...
     <table width="600" border="0" align="left" cellpadding="0" cellspacing="0" hight="100" name="zhuce" >
		<tr>
		  ...
		  <div class="denglu_xuanfu">请输入您的邮箱或昵称</div></div></td>
		  <td width="40%" id="ckusername"><label class="field_notice">请输入邮箱或昵称</label></td>
		</tr>
		<tr>
      ...
      <div class="register_right">
         <div class="hezuo">
          ...
          <h3>还没有账号？轻松注册 ！ </h3>
         <a href="<?=u('user','register',array('from'=>$url_from))?>" class="register_b2" style="display:block; margin-top:20px; margin-bottom:20px">注 册</a></div>
        </div>
