...
<?=AD(14)?>
    ...
    <div class="register_left">
     <p class="title">免费注册一淘乐购，网购省钱第一站</p>
...
<table width="680" border="0" align="left" cellpadding="0" cellspacing="0">
		...
		<tr>
		  ...
		  <td><label class="field_notice">推荐人帐号/邮箱</label><label id="checking_tjrname" class="checking">检查中...</label></td>
		</tr>
        <?php }?>
      ...
      <div class="register_right">
         <div class="hezuo">
               ...
               <h3>已经有帐号？请直接登录</h3>
<a href="/index.php?mod=user&act=login" class="register_b2" style="display:block; margin-top:20px; margin-bottom:20px">账号登录</a>
