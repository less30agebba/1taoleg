...
<?php }?>
    ...
    <div class="index_head"> <span class="logol">
      ...
      <!--<span><a class="denglu" href="#0">登录</a>  |<a class="qiandao" href="#0">签到</a></span>--> 
      <span class="right"><a class="denglu" href="<?=wap_l('index','index')?>"><i class="icon iconfont">&#xe6a7;</i></a></span> <span class="left"><a class="denglu" href="javascript:history.go(-1);"><i class="icon iconfont">&#xe6a2;</i></a></span> </div>
    <?php }?>
<?php }?>
<?php }?>