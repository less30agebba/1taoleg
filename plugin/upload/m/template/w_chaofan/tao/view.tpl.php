...
<?php if($shuju_data['title']!=''){?>
    ...
    <dd>
      ...
      <div style=" width:<?=$dd_wap_class->is_weixin()==1?'260':'200'?>px; margin:auto">
         <a style="display:inline-block;" title="分享到新浪微博" href="http://service.weibo.com/share/mobile.php?title=<?=$shuju_data['title']?>&pic=<?=$shuju_data['img']?>&url=<?=$share_url?>&summary=赚钱是一种能力，花钱是一种技术，我能力有限，技术却很高。幸好及时发现了<?=$webset['title']?>，挣钱能力虽然没涨，但省钱能力猛增！！"><img src="<?=TPLURL?>/inc/images/sina.png" width="100%" /></a>
         ...
         <a style="display:inline-block;" title="分享到QQ空间" href="http://openmobile.qq.com/oauth2.0/m_jump?loginpage=loginindex.html&logintype=qzone&page=qzshare.html&summary=赚钱是一种能力，花钱是一种技术，我能力有限，技术却很高。幸好及时发现了<?=$webset['title']?>，挣钱能力虽然没涨，但省钱能力猛增！！&imageUrl=<?=$shuju_data['img']?>&url=<?=$share_url?>&title=<?=$shuju_data['title']?>&callbackUrl=<?=$share_url?>"><img src="<?=TPLURL?>/inc/images/qzone.png" width="100%" /></a>
         <a style="display:inline-block;" href="http://share.v.t.qq.com/index.php?c=share&a=index&title=<?=$shuju_data['title']?>&pic=<?=$shuju_data['img']?>&url=<?=$share_url?>&summary=赚钱是一种能力，花钱是一种技术，我能力有限，技术却很高。幸好及时发现了<?=$webset['title']?>，挣钱能力虽然没涨，但省钱能力猛增！！"><img src="<?=TPLURL?>/inc/images/txweibo.png" width="100%" /></a>
         </div>
	  </dl>
 ...
 <?php }else{?>
    <a href='<?=wap_l('jump','index',array('iid'=>iid_encode($shuju_data['num_iid'])))?>' target="_blank"class="left">去淘宝购买</a>
 <?php }?>
