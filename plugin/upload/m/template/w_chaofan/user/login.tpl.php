...
extract($parameter);
$right_jump='<a class="denglu" href="'.wap_l('user','register',array('from'=>$from)).'"><i class="icon iconfont">注册</i></a>';
...
function getYzm(){
	$('#yzmimg').attr('src','<?=SITEURL?>/comm/showpic.php?easy=1&t='+time());
}
</script>
<div class="shopBody">
...
<dl id="yzmdiv">
    ...
    <td><img id="yzmimg" src='<?=SITEURL?>/comm/showpic.php?easy=1'  onClick="getYzm()" style=""></td>
    </tr>
    </table>
    </dt>
    </dl>
